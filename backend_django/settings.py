...
SECRET_KEY = 'django-insecure-q7%3jy)2px5*p4ls_s3qr^jafs-hkr@yq*4gn5f%s6+qh+a(cg'
...
CORS_ALLOWED_ORIGINS = [
    "http://localhost:3000",  # If testing on Flutter Web
    "http://127.0.0.1:3000",
    "http://localhost:8000",  # Django Backend
    "http://127.0.0.1:8000",
    "http://192.168.31.235:8000",
    "http://192.168.105.128:8000",
    "http://192.168.181.128:8000",
]
CORS_ALLOW_METHODS = [
    "GET",
    "POST",
